...
export function validateYargsArguments(parsed: any, knownOpts: any, shorthands: any, clientName: string, isInTestMode?: boolean): void {

	if(path.basename(process.argv[1]).indexOf(clientName) !== -1 || isInTestMode) {
